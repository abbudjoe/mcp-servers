...
"""Fail-fast guards for the canonical scientific stack."""
...
def test_canonical_python_and_package_versions() -> None:
    ...
    assert sys.version_info[:3] == (3, 12, 12), (
        "The canonical stack requires CPython 3.12.12; use the lock CI job or "
...
def test_primitive_v2_pub_and_result_shapes() -> None:
    """Guard Primitive V2 PUB coercion and per-PUB result containers."""
