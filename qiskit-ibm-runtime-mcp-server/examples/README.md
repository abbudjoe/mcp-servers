...
| File | Description |
|------|-------------|
| [`runtime_contracts.py`](runtime_contracts.py) | Offline exact-circuit, artifact, and schema example; no credentials or QPU call |
...
compatibility stubs. Live submission must use the typed
