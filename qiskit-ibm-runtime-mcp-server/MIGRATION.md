...
Jobs submitted by 0.7.0 or 0.7.1 lack the wrapper submission-time tag. Keep
their original `BatchSubmissionReceipt`; 0.7.2 intentionally refuses to invent
a receipt timestamp from nullable `creation_date` metadata.
